...
interface PrestamoRepository {
    ...
    fun getEvidencias(prestamoId: String): Flow<List<EvidenciaEntity>>
    ...
    suspend fun guardarEvidenciaLocal(evidencia: EvidenciaEntity): Result<Unit>
    suspend fun subirEvidencia(id: String): Result<Unit>
}
